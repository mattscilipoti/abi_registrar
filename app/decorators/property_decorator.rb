class PropertyDecorator < Draper::Decorator
  ...
  def toggleable_amenities_processed?
    h.toggleable_date_as_boolean(model: property, attribute_name: :amenities_processed)
  end
  ...
  def toggleable_lot_fees_paid?
    h.toggleable_date_as_boolean(model: property, attribute_name: :lot_fees_paid_on, boolean_attribute_name: 'lot_fees_paid?')
  end

  def toggleable_user_fee_paid?
    h.toggleable_date_as_boolean(model: property, attribute_name: :user_fee_paid_on)
  end
